...
plt.plot(preco_real_open, color = 'red', label = 'Pre̤o abertura real')
plt.plot(preco_real_high, color = 'black', label = 'Pre̤o alta real')

plt.plot(previsoes[:, 0], color = 'blue', label = 'Previs̵es abertura')
plt.plot(previsoes[:, 1], color = 'orange', label = 'Previs̵es alta')
